...
saveRDS(all_est_prob, file = file.path(path_multiple_imputation_pipeline_data, "mi-analysis-results", "replicates_est_prob_prompt_by_dp.rds"))
saveRDS(all_est_var, file = file.path(path_multiple_imputation_pipeline_data, "mi-analysis-results", "replicates_est_var_prompt_by_dp.rds"))
...
saveRDS(all_est_prob, file = file.path(path_multiple_imputation_pipeline_data, "mi-analysis-results", "replicates_est_prob_no_prompt_by_dp.rds"))
saveRDS(all_est_var, file = file.path(path_multiple_imputation_pipeline_data, "mi-analysis-results", "replicates_est_var_no_prompt_by_dp.rds"))
...
saveRDS(all_est_prob, file = file.path(path_multiple_imputation_pipeline_data, "mi-analysis-results", "replicates_est_prob_high_effort_prompt_by_dp.rds"))
saveRDS(all_est_var, file = file.path(path_multiple_imputation_pipeline_data, "mi-analysis-results", "replicates_est_var_high_effort_prompt_by_dp.rds"))
...
saveRDS(all_est_prob, file = file.path(path_multiple_imputation_pipeline_data, "mi-analysis-results", "replicates_est_prob_low_effort_prompt_by_dp.rds"))
saveRDS(all_est_var, file = file.path(path_multiple_imputation_pipeline_data, "mi-analysis-results", "replicates_est_var_low_effort_prompt_by_dp.rds"))
