...
saveRDS(all_est_logodds_scale, file = file.path(path_multiple_imputation_pipeline_data, "mi-analysis-results", "replicates_est_logodds_prompt_by_dp.rds"))
saveRDS(all_var_logodds_scale, file = file.path(path_multiple_imputation_pipeline_data, "mi-analysis-results", "replicates_var_logodds_prompt_by_dp.rds"))
...
saveRDS(all_est_logodds_scale, file = file.path(path_multiple_imputation_pipeline_data, "mi-analysis-results", "replicates_est_logodds_no_prompt_by_dp.rds"))
saveRDS(all_var_logodds_scale, file = file.path(path_multiple_imputation_pipeline_data, "mi-analysis-results", "replicates_var_logodds_no_prompt_by_dp.rds"))
...
saveRDS(all_est_logodds_scale, file = file.path(path_multiple_imputation_pipeline_data, "mi-analysis-results", "replicates_est_logodds_high_effort_prompt_by_dp.rds"))
saveRDS(all_var_logodds_scale, file = file.path(path_multiple_imputation_pipeline_data, "mi-analysis-results", "replicates_var_logodds_high_effort_prompt_by_dp.rds"))
...
saveRDS(all_est_logodds_scale, file = file.path(path_multiple_imputation_pipeline_data, "mi-analysis-results", "replicates_est_logodds_low_effort_prompt_by_dp.rds"))
saveRDS(all_var_logodds_scale, file = file.path(path_multiple_imputation_pipeline_data, "mi-analysis-results", "replicates_var_logodds_low_effort_prompt_by_dp.rds"))
