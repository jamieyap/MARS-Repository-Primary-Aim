...
dat_wide_init <- readRDS(file = file.path(path_multiple_imputation_pipeline_data, "sequentially-completed-datasets", mi_dataset_num, paste("dat_wide_init_block", current_dp_value, ".rds", sep = "")))
dat_wide_completed <- readRDS(file = file.path(path_multiple_imputation_pipeline_data, "sequentially-completed-datasets", mi_dataset_num, paste("dat_wide_completed_block", current_dp_value, ".rds", sep = "")))
...
var_to_check <- paste("Y", suffix, sep = "")
dat_for_plotting <- prepare_data_for_plotting(variable_name = var_to_check, data_before_imputation = dat_wide_init, data_after_imputation = dat_wide_completed, eligibility_indicator = paste("eligibility", suffix, sep = ""))
...
ggsave(filename =  file.path(this_location, paste("Y", suffix, ".png", sep = "")), 
       plot = g_out,
...
var_to_check <- paste("Y", suffix, sep = "")
use_subgroup_indicator <- paste("coinflip", suffix, sep = "")
...
dat_for_plotting <- prepare_data_for_plotting(variable_name = var_to_check, data_before_imputation = dat_wide_init, data_after_imputation = dat_wide_completed, eligibility_indicator = paste("eligibility", suffix, sep = ""), subgroup_indicator = use_subgroup_indicator)
...
ggsave(filename = file.path(this_location, paste("Y", suffix, "_by_trt", ".png", sep = "")),
       plot = g_out,
       height = 10, width = 10, units = "in")

###############################################################################
# quick_survey_response_dp3 -- overall
###############################################################################

var_to_check <- paste("quick_survey_response", suffix, sep = "")
dat_for_plotting <- prepare_data_for_plotting(variable_name = var_to_check, data_before_imputation = dat_wide_init, data_after_imputation = dat_wide_completed, eligibility_indicator = paste("eligibility", suffix, sep = ""))
n_missing <- dat_for_plotting %>% 
  filter(is_observed != "observed") %>%
  nrow(.)
...
ggsave(filename = file.path(this_location, paste("quick_survey_response", suffix, ".png", sep = "")), 
       plot = g_out,
...
var_to_check <- paste("cigarette_counts", suffix, sep = "")
dat_for_plotting <- prepare_data_for_plotting(variable_name = var_to_check, data_before_imputation = dat_wide_init, data_after_imputation = dat_wide_completed, eligibility_indicator = paste("eligibility", suffix, sep = ""))
n_missing <- dat_for_plotting %>% 
  filter(is_observed != "observed") %>%
  nrow(.)
...
ggsave(filename = file.path(this_location, paste("cigarette_counts", suffix, ".png", sep = "")), 
       plot = g_out,
       height = 10, width = 5, units = "in")
...
var_to_check <- paste("src_scored", suffix, sep = "")
dat_for_plotting <- prepare_data_for_plotting(variable_name = var_to_check, data_before_imputation = dat_wide_init, data_after_imputation = dat_wide_completed, eligibility_indicator = paste("eligibility", suffix, sep = ""))
n_missing <- dat_for_plotting %>% 
  filter(is_observed != "observed") %>%
  nrow(.)
...
ggsave(filename = file.path(this_location, paste("src_scored", suffix, ".png", sep = "")), 
       plot = g_out,
       height = 10, width = 5, units = "in")
