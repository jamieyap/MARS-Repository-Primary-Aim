...
dat_wide_init <- readRDS(file = file.path(path_multiple_imputation_pipeline_data, "sequentially-completed-datasets", mi_dataset_num, "dat_wide_init_block1.rds"))
dat_wide_completed <- readRDS(file = file.path(path_multiple_imputation_pipeline_data, "sequentially-completed-datasets", mi_dataset_num, "dat_wide_completed_block1.rds"))
...
ggsave(filename = file.path(this_location, "Y_dp1.png"), 
       plot = g_out,
...
var_to_check <- "Y_dp1"
use_subgroup_indicator <- "coinflip_dp1"
...
ggsave(filename = file.path(this_location, "quick_survey_response_dp1.png"), 
       plot = g_out,
