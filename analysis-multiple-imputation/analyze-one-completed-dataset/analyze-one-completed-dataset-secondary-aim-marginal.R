...
if(class(fit1) == "character"){
  ...
  Lmat <- matrix(c(1,-1), ncol = 2, byrow = TRUE)
...
saveRDS(fit1_converted, file.path(path_multiple_imputation_pipeline_data, "mi-analysis-results", mi_dataset_num, paste(add_prefix, "fit_obj_secondary_marginal.rds", sep = "")))
saveRDS(results_obj, file.path(path_multiple_imputation_pipeline_data, "mi-analysis-results", mi_dataset_num, paste(add_prefix, "results_obj_secondary_marginal.rds", sep = "")))
...
for(idx_replicate in 1:max_replicate_id){
  ...
  saveRDS(fit1_converted, file.path(path_multiple_imputation_pipeline_data, "mi-analysis-results", mi_dataset_num, paste(add_prefix, "fit1_obj_secondary_marginal", "_replicate_", idx_replicate, ".rds", sep = "")))
  saveRDS(results_obj, file.path(path_multiple_imputation_pipeline_data, "mi-analysis-results", mi_dataset_num, paste(add_prefix, "results_obj_secondary_marginal", "_replicate_", idx_replicate, ".rds", sep = "")))
}
