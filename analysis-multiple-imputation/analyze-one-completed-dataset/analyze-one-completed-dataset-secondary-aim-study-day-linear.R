...
if(class(fit1) == "character"){
  ...
  Lmat2 <- matrix(cbind(rep(1,8),
                        seq(2,9,1),
                        rep(-1,8),
                        -1*seq(2,9,1)), ncol = 4, byrow = FALSE)
...
saveRDS(fit1_converted, file.path(path_multiple_imputation_pipeline_data, "mi-analysis-results", mi_dataset_num, "fit_obj_secondary_study_day_linear.rds"))
saveRDS(results_obj, file.path(path_multiple_imputation_pipeline_data, "mi-analysis-results", mi_dataset_num, "results_obj_secondary_study_day_linear.rds"))
...
for(idx_replicate in 1:max_replicate_id){
  ...
  saveRDS(fit1_converted, file.path(path_multiple_imputation_pipeline_data, "mi-analysis-results", mi_dataset_num, paste("fit1_obj_secondary_study_day_linear", "_replicate_", idx_replicate, ".rds", sep = "")))
