...
saveRDS(fit1, file.path(path_multiple_imputation_pipeline_data, "mi-analysis-results", mi_dataset_num, paste(add_prefix, "fit_obj_primary_marginal_risk_difference.rds", sep = "")))
saveRDS(results_obj, file.path(path_multiple_imputation_pipeline_data, "mi-analysis-results", mi_dataset_num, paste(add_prefix, "results_obj_primary_marginal_risk_difference.rds", sep = "")))
...
for(idx_replicate in 1:max_replicate_id){
  ...
  saveRDS(fit1, file.path(path_multiple_imputation_pipeline_data, "mi-analysis-results", mi_dataset_num, paste(add_prefix, "fit_obj_primary_marginal", "_replicate_", idx_replicate, "_risk_difference", ".rds", sep = "")))
  saveRDS(results_obj, file.path(path_multiple_imputation_pipeline_data, "mi-analysis-results", mi_dataset_num, paste(add_prefix, "results_obj_primary_marginal", "_replicate_", idx_replicate, "_risk_difference", ".rds", sep = "")))
}
