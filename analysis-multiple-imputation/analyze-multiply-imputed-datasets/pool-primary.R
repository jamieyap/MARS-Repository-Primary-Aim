...
# Causal part of the analysis model -------------------------------------------
results_obj <- readRDS(file = file.path(path_multiple_imputation_pipeline_data, "mi-analysis-results", 1, "results_obj_primary_linear_time.rds"))
...
row.names(fit_pooled) <- c("Treatment (Prompt = 1, No Prompt = 0)", "Treatment x Day")
fit_pooled_causal <- fit_pooled
...
write.csv(fit_pooled_causal, file = file.path("analysis-multiple-imputation", "formatted-output", "pooled_H1_causal_linear_time.csv"), row.names = TRUE)
write.csv(fit_pooled_control, file = file.path("analysis-multiple-imputation", "formatted-output", "pooled_H1_control_linear_time.csv"), row.names = TRUE)
...
# Causal part of the analysis model -------------------------------------------
results_obj <- readRDS(file = file.path(path_multiple_imputation_pipeline_data, "mi-analysis-results", 1, "results_obj_primary_quadratic_time.rds"))
num_terms <- nrow(results_obj$causal_excursion_effect)
...
row.names(fit_pooled) <- c("Treatment (Prompt = 1, No Prompt = 0)", "Treatment x Day", "Treatment x Day Squared")
fit_pooled_causal <- fit_pooled
...
write.csv(fit_pooled_causal, file = file.path("analysis-multiple-imputation", "formatted-output", "pooled_H1_causal_quadratic_time.csv"), row.names = TRUE)
write.csv(fit_pooled_control, file = file.path("analysis-multiple-imputation", "formatted-output", "pooled_H1_control_quadratic_time.csv"), row.names = TRUE)
...
for(mi_dataset_num in 1:.__total_imputed_datasets){
  idx_replicate <- 1
  results_obj_rep <- readRDS(file = file.path(path_multiple_imputation_pipeline_data, "mi-analysis-results", mi_dataset_num, paste("results_obj_primary_linear_time", "_replicate_", idx_replicate, ".rds", sep = "")))
  results_obj <- readRDS(file = file.path(path_multiple_imputation_pipeline_data, "mi-analysis-results", mi_dataset_num, "results_obj_primary_linear_time.rds"))
...
dat_pbcom <- data.frame(pbcom_est, pbcom_stderr)
dat_pbcom <- format(round(dat_pbcom, 3), nsmall = 3)
write.csv(dat_pbcom, file = file.path("analysis-multiple-imputation", "formatted-output", "pbcom_H1_causal_linear_time.csv"), row.names = TRUE)
...
for(mi_dataset_num in 1:.__total_imputed_datasets){
  idx_replicate <- 1
  results_obj_rep <- readRDS(file = file.path(path_multiple_imputation_pipeline_data, "mi-analysis-results", mi_dataset_num, paste("results_obj_primary_quadratic_time", "_replicate_", idx_replicate, ".rds", sep = "")))
  results_obj <- readRDS(file = file.path(path_multiple_imputation_pipeline_data, "mi-analysis-results", mi_dataset_num, "results_obj_primary_quadratic_time.rds"))
...
dat_pbcom <- data.frame(pbcom_est, pbcom_stderr)
dat_pbcom <- format(round(dat_pbcom, 3), nsmall = 3)
write.csv(dat_pbcom, file = file.path("analysis-multiple-imputation", "formatted-output", "pbcom_H1_causal_quadratic_time.csv"), row.names = TRUE)
