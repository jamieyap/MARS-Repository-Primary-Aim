...
cond1 <- paste("(", paste("eligibility", suffix, " == 1", sep = ""), " & ", paste("eligibility_lag1" , suffix, " == 1", sep = ""), " & ", paste("elig24hrs" , suffix, " == 0", sep = ""), ")", sep = "")
cond2 <- paste("(", paste("eligibility", suffix, " == 1", sep = ""), " & ", paste("eligibility_lag1" , suffix, " == 0", sep = ""), " & ", paste("elig24hrs" , suffix, " == 1", sep = ""), ")", sep = "")
cond3 <- paste("(", paste("eligibility", suffix, " == 1", sep = ""), " & ", paste("eligibility_lag1" , suffix, " == 0", sep = ""), " & ", paste("elig24hrs" , suffix, " == 0", sep = ""), ")", sep = "")
list_restriction_meet_string <- list("most_stringent" = paste(paste("eligibility", suffix, " == 1", sep = ""), " & ", paste("eligibility_lag1" , suffix, " == 1", sep = ""), " & ", paste("elig24hrs" , suffix, " == 1", sep = ""), sep = ""),
                                     "less_stringent" = paste(cond1, cond2, cond3, sep = " | "))
...
RHS <- paste(paste("quick_survey_response_lag1", suffix, sep = ""), 
...
this_outcome <- "Y"
LHS <- paste(this_outcome, suffix, sep = "")
RHS <- paste(paste("Y_sum_past24hrs", suffix, sep = ""),
