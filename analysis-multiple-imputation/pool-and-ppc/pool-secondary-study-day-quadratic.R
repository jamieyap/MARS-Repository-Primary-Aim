...
plot(2:9, fit_pooled_causal[-c(1:9),]$Estimate, type = "o", ylim = c(-0.10, 0.40), xlab = "Study Day", ylab = "Treatment Effect on the Log-Scale")
lines(2:9, fit_pooled_causal[-c(1:9),]$LCL, type = "o", lty = 2)
lines(2:9, fit_pooled_causal[-c(1:9),]$UCL, type = "o", lty = 2)
...
plot(2:9, exp(fit_pooled_causal[-c(1:9),]$Estimate), type = "o", ylim = c(0.7,1.5), xlab = "Study Day", ylab = "Treatment Effect on the Risk Ratio-Scale")
lines(2:9, exp(fit_pooled_causal[-c(1:9),]$LCL), type = "o", lty = 2)
lines(2:9, exp(fit_pooled_causal[-c(1:9),]$UCL), type = "o", lty = 2)
