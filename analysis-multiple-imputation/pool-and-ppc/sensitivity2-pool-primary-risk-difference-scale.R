...
for(mi_dataset_num in 1:.__total_imputed_datasets){
  results_obj <- readRDS(file = file.path(path_multiple_imputation_pipeline_data, "mi-analysis-results", mi_dataset_num, "sensitivity2_results_obj_primary_marginal_risk_difference.rds"))
...
results_obj <- readRDS(file = file.path(path_multiple_imputation_pipeline_data, "mi-analysis-results", 1, "sensitivity2_results_obj_primary_marginal_risk_difference.rds"))
...
write.csv(fit_pooled_causal_formatted, file = file.path("analysis-multiple-imputation", "formatted-output", "sensitivity2_pooled_H1_causal_risk_difference_scale.csv"), row.names = TRUE)
write.csv(fit_pooled_control_formatted, file = file.path("analysis-multiple-imputation", "formatted-output", "sensitivity2_pooled_H1_control_risk_difference_scale.csv"), row.names = TRUE)
write.csv(pool_stats_formatted, file = file.path("analysis-multiple-imputation", "formatted-output", "sensitivity2_pool_stats_H1_causal_risk_difference_scale.csv"), row.names = TRUE)
