...
dat_primary_aim <- dat_primary_aim %>%
  ...
  mutate(nreported_past24hrs = quick_survey_nreported_past24hrs + Y_nreported_past24hrs)
```
...
```{r}
rhs <- "is_high_effort_sum_past24hrs"
lhs <- "Y"
my_formula <- formula(paste(lhs, "~", rhs, sep = ""))
...
```{r}
rhs <- "is_low_effort_sum_past24hrs"
lhs <- "Y"
my_formula <- formula(paste(lhs, "~", rhs, sep = ""))
...
```{r}
rhs <- "quick_survey_nreported_past24hrs"
lhs <- "Y"
my_formula <- formula(paste(lhs, "~", rhs, sep = ""))
...
# What would make good predictors for time-varying variables that ended up in the shortlist
