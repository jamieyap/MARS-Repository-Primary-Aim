...
write.csv(dat_all_out, file.path(path_code, "analysis-multiple-imputation", "diagnostics", "stratum02_linear.csv"))
```
...
write.csv(dat_all_out_quadratic, file.path(path_code, "analysis-multiple-imputation", "diagnostics", "stratum02_quadratic.csv"))
```
