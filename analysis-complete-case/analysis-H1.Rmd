...
my_list <- list(Y = 0,
                coinflip = 0,
                hour_coinflip_local = 0, 
                days_between_v1_and_coinflip_local = 0,
                any_response_2qs = 0, 
                any_recent_eligible_dp = 0, 
                engagement_most_recent_eligible = 0,
                age = 0, 
                is_female = 0, 
                is_latino = 0, 
                is_not_latino_and_black = 0, 
                is_not_latino_and_other = 0, 
                baseline_tobacco_history = 0, 
                has_partner = 0, 
                income_val = 0)
```
