---
title: "Sensitivity Analysis for H2 with tracked engagement with self-regulatory strategies as proximal outcome"
...
is_dir_exist <- file.exists(file.path("analysis-complete-case", "formatted-output", "sensitivity-H2-tracked-engagement-as-proximal-outcome"))

if(isFALSE(is_dir_exist)){
  dir.create(file.path("analysis-complete-case", "formatted-output", "sensitivity-H2-tracked-engagement-as-proximal-outcome"))
}
```
...
dat_for_analysis <- dat_primary_aim %>%
  ...
  rename(Y = tracked_engagement_done_cutoff_combined)
```
...
dat_prevalence %>% round(., 3) %>% format(., nsmall = 3) %>% write.csv(., file.path("analysis-complete-case", "formatted-output", "sensitivity-H2-tracked-engagement-as-proximal-outcome", "prevalence_by_group_H2.csv"), row.names = TRUE)
```
...
ggsave(filename = file.path("analysis-complete-case", "formatted-output", "sensitivity-H2-tracked-engagement-as-proximal-outcome", "prevalence.png"), dpi = 1200)
```
...
ggsave(filename = file.path("analysis-complete-case", "formatted-output", "sensitivity-H2-tracked-engagement-as-proximal-outcome", "prevalence_HL.png"), dpi = 1200)
```
...
# Format output to 3 decimal places
dat_result %>% format(., nsmall = 3) %>% write.csv(., file.path("analysis-complete-case", "formatted-output", "sensitivity-H2-tracked-engagement-as-proximal-outcome", "log_risk_ratio_scale_H2.csv"), row.names = TRUE)
```
...
# Format output to 3 decimal places
results_contrast %>% format(., nsmall = 3) %>% write.csv(., file.path("analysis-complete-case", "formatted-output", "sensitivity-H2-tracked-engagement-as-proximal-outcome", "log_risk_ratio_scale_contrast_H2.csv"), row.names = TRUE)
```
...
# Format output to 3 decimal places
dat_exp_scale %>% format(., nsmall = 3) %>% write.csv(., file.path("analysis-complete-case", "formatted-output", "sensitivity-H2-tracked-engagement-as-proximal-outcome", "risk_ratio_scale_contrast_H2.csv"), row.names = TRUE)
```
...
dat_result %>% format(., nsmall = 3) %>% write.csv(., file.path("analysis-complete-case", "formatted-output", "sensitivity-H2-tracked-engagement-as-proximal-outcome", "risk_difference_scale_H2.csv"), row.names = TRUE)
```
...
dat_result %>% format(., nsmall = 3) %>% write.csv(., file.path("analysis-complete-case", "formatted-output", "sensitivity-H2-tracked-engagement-as-proximal-outcome", "risk_difference_scale_contrast_H2.csv"), row.names = TRUE)
```
