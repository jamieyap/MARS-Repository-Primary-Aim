...
dat_primary_aim <- dat_primary_aim %>%
  ...
  mutate(ashamed_lag1 = lag(ashamed), 
         ...
         substance_is_cigarettes_new_lag1 = lag(substance_is_cigarettes_new)) %>%
...
my_list <- list(Y = -1,
                ...
                substance_is_cigarettes_new_lag1 = -1,
                # Past 24 hours
                ...
                substance_is_cigarettes_new_sum_past24hrs = -1)
```
...
use_these_moderators <- c("ashamed_lag1",
                          ...
                          "alcohol_counts_lag1",
                          "substance_is_cigarettes_new_lag1")
...
dat_summary <- data.frame(n_elig_overall_past_dp = sum(dat_summary_observed[["total"]]),
                          n_included_among_elig_overall_past_dp = dat_summary_observed[dat_summary_observed[["is_complete"]] == TRUE, ][["total"]],
                          n_excluded_among_elig_overall_past_dp = dat_summary_observed[dat_summary_observed[["is_complete"]] == FALSE, ][["total"]])
...
dat_summary <- data.frame(n_elig_overall_past_dp = sum(dat_summary_observed[["total"]]),
                          n_included_among_elig_overall_past_24h = dat_summary_observed[dat_summary_observed[["is_complete"]] == TRUE, ][["total"]],
                          n_excluded_among_elig_overall_past_24h = dat_summary_observed[dat_summary_observed[["is_complete"]] == FALSE, ][["total"]])
...
```{r}
use_these_moderators <- c("substance_is_cigarettes_new_lag1")
...
fit1 <- emee(
  ...
  treatment = "coinflip",
  rand_prob = 0.5,
  moderator_formula = ~ substance_is_cigarettes_new_lag1,  
  control_formula = ~ substance_is_cigarettes_new_lag1 + age + is_female + is_latino + is_not_latino_and_black + is_not_latino_and_other + baseline_tobacco_history + has_partner + income_val + hour_coinflip_local + days_between_v1_and_coinflip_local + any_response_2qs + engagement_most_recent_eligible, 
  availability = "eligibility"
)
...
```{r}
use_these_moderators <- c("substance_is_cigarettes_new_sum_past24hrs")
...
fit1 <- emee(
  ...
  treatment = "coinflip",
  rand_prob = 0.5,
  moderator_formula = ~ substance_is_cigarettes_new_sum_past24hrs,  
  control_formula = ~ substance_is_cigarettes_new_sum_past24hrs + age + is_female + is_latino + is_not_latino_and_black + is_not_latino_and_other + baseline_tobacco_history + has_partner + income_val + hour_coinflip_local + days_between_v1_and_coinflip_local + any_response_2qs + engagement_most_recent_eligible, 
  availability = "eligibility"
)
...
# table(dat_for_analysis$any_response_2qs, dat_for_analysis$substance_is_cigarettes_new_sum_past24hrs)
```
