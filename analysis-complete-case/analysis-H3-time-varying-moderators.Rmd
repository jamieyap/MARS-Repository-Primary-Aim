...
dat_primary_aim <- dat_primary_aim %>%
  ...
  mutate(ashamed_lag1 = lag(ashamed), 
         ...
         substance_is_any_tobacco_lag1 = lag(substance_is_any_tobacco),
...
my_list <- list(Y = -1,
                ...
                substance_is_any_tobacco_lag1 = -1,
                cigarette_availability_lag1 = -1,
                # Past 24 hours
                coinflip_sum_past24hrs = -1,
                ashamed_mean_past24hrs = -1,
                guilty_mean_past24hrs = -1,
                happy_mean_past24hrs = -1,
                src_scored_mean_past24hrs = -1,
                cigarette_availability_mean_past24hrs = -1,
                ...
                substance_is_any_tobacco_sum_past24hrs = -1)
...
use_these_moderators <- c("ashamed_lag1",
                          ...
                          "ashamed_mean_past24hrs",
                          "guilty_mean_past24hrs",
                          "happy_mean_past24hrs",
                          "src_scored_mean_past24hrs",
                          "cigarette_availability_mean_past24hrs",
                          "stressor_is_any_sum_past24hrs",
                          "cigarette_counts_sum_past24hrs",
                          "alcohol_counts_sum_past24hrs",
                          "substance_is_any_sum_past24hrs",
                          "substance_is_any_nicotine_sum_past24hrs",
                          "substance_is_marijuana_or_cannabis_sum_past24hrs",
                          "substance_is_alcohol_sum_past24hrs",
                          "substance_is_cigarettes_sum_past24hrs")
```
...
```{r}
use_these_moderators <- c("cigarette_availability_lag1")
```
...
fit1 <- emee(
  ...
  treatment = "coinflip",
  rand_prob = 0.5,
  moderator_formula = ~ cigarette_availability_lag1,  
  control_formula = ~ cigarette_availability_lag1 + age + is_male + is_latino + is_not_latino_and_black + is_not_latino_and_other + baseline_tobacco_history + has_partner + income_val + hour_coinflip_local + days_between_v1_and_coinflip_local + any_response_2qs + engagement_most_recent_eligible, 
  availability = "eligibility_overall_past_dp"
)
...
# Format output to 3 decimal places
dat_result %>% round(., 3) %>% format(., nsmall = 3) %>% write.csv(., file.path("analysis-complete-case", "formatted-output", "H3-time-varying-moderators", "log_risk_ratio_scale_H3_cigarette_availability_lag1.csv"), row.names = TRUE)
```
...
```{r}
use_these_moderators <- c("substance_is_any_tobacco_lag1")
```
...
fit1 <- emee(
  ...
  treatment = "coinflip",
  rand_prob = 0.5,
  moderator_formula = ~ substance_is_any_tobacco_lag1,  
  control_formula = ~ substance_is_any_tobacco_lag1 + age + is_male + is_latino + is_not_latino_and_black + is_not_latino_and_other + baseline_tobacco_history + has_partner + income_val + hour_coinflip_local + days_between_v1_and_coinflip_local + any_response_2qs + engagement_most_recent_eligible, 
  availability = "eligibility_overall_past_dp"
)
...
# Format output to 3 decimal places
dat_result %>% round(., 3) %>% format(., nsmall = 3) %>% write.csv(., file.path("analysis-complete-case", "formatted-output", "H3-time-varying-moderators", "log_risk_ratio_scale_H3_substance_is_any_tobacco_lag1.csv"), row.names = TRUE)
```
...
```{r}
use_these_moderators <- c("cigarette_availability_mean_past24hrs")
```
...
fit1 <- emee(
  ...
  treatment = "coinflip",
  rand_prob = 0.5,
  moderator_formula = ~ cigarette_availability_mean_past24hrs,  
  control_formula = ~ cigarette_availability_mean_past24hrs + age + is_male + is_latino + is_not_latino_and_black + is_not_latino_and_other + baseline_tobacco_history + has_partner + income_val + hour_coinflip_local + days_between_v1_and_coinflip_local + any_response_2qs + engagement_most_recent_eligible, 
  availability = "eligibility_overall_past_24h"
)
...
# Format output to 3 decimal places
dat_result %>% round(., 3) %>% format(., nsmall = 3) %>% write.csv(., file.path("analysis-complete-case", "formatted-output", "H3-time-varying-moderators", "log_risk_ratio_scale_H3_cigarette_availability_mean_past24hrs.csv"), row.names = TRUE)
```
...
```{r}
use_these_moderators <- c("substance_is_any_tobacco_sum_past24hrs")
```
...
fit1 <- emee(
  ...
  treatment = "coinflip",
  rand_prob = 0.5,
  moderator_formula = ~ substance_is_any_tobacco_sum_past24hrs,  
  control_formula = ~ substance_is_any_tobacco_sum_past24hrs + age + is_male + is_latino + is_not_latino_and_black + is_not_latino_and_other + baseline_tobacco_history + has_partner + income_val + hour_coinflip_local + days_between_v1_and_coinflip_local + any_response_2qs + engagement_most_recent_eligible, 
  availability = "eligibility_overall_past_24h"
)
...
# Format output to 3 decimal places
dat_result %>% round(., 3) %>% format(., nsmall = 3) %>% write.csv(., file.path("analysis-complete-case", "formatted-output", "H3-time-varying-moderators", "log_risk_ratio_scale_H3_substance_is_any_tobacco_sum_past24hrs.csv"), row.names = TRUE)
```


```{r}
if(file.exists("analysis-complete-case/formatted-output/H3-time-varying-moderators/Thumbs.db")){
  file.remove("analysis-complete-case/formatted-output/H3-time-varying-moderators/Thumbs.db")
}
```
