...
```{r}
if(file.exists("analysis-complete-case/formatted-output/H3-app-usage-moderators/Thumbs.db")){
  file.remove("analysis-complete-case/formatted-output/H3-app-usage-moderators/Thumbs.db")
}
```
