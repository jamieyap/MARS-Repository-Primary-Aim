...
dat_for_analysis <- dat_for_analysis %>%
  mutate(treatment_cate = case_when(
    is_low_effort == 1 ~ 0,  # Important note: the value of zero in treatment_cate is used to indicate the reference category to be used. Another important note: we actually want low effort prompt rather than no prompt to be our reference category; therefore, the variable treatment_cate was specified in this way
...
new_row_names <- replace(new_row_names, orig_row_names == "1", "High Effort Prompt (versus Low Effort)")
new_row_names <- replace(new_row_names, orig_row_names == "2", "High Effort Prompt (versus Low Effort) x Day in Study")
new_row_names <- replace(new_row_names, orig_row_names == "3", "High Effort Prompt (versus Low Effort) x Day in Study x Day in Study")
new_row_names <- replace(new_row_names, orig_row_names == "4", "No Prompt (versus Low Effort)")
new_row_names <- replace(new_row_names, orig_row_names == "5", "No Prompt (versus Low Effort) x Day in Study")
new_row_names <- replace(new_row_names, orig_row_names == "6", "No Prompt (versus Low Effort) x Day in Study x Day in Study")
row.names(dat_causal) <- new_row_names
```
