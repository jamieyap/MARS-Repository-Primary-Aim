...
```{r}
png(file = file.path("analysis-complete-case", "formatted-output", "Exploratory-Analysis-Associational-Nicotine-Use", "analytic_population_by_day_concurrent.png"), width = 10, height = 10, units = "in", res = 600)
...
title(main = "Concurrent analysis at the day level: Nicotine Use")
...
```{r}
png(file = file.path("analysis-complete-case", "formatted-output", "Exploratory-Analysis-Associational-Nicotine-Use", "analytic_population_by_day_lagged.png"), width = 10, height = 10, units = "in", res = 600)
...
title(main = "Lagged analysis at the day level: Nicotine Use")

dev.off()
```


# Association between engagement in self-regulatory strategies and use of any nicotine-containing product on current day
...
# Time-varying association between engagement in self-regulatory strategies and use of any nicotine-containing product on current day
...
# Association between engagement in self-regulatory strategies and use of any nicotine-containing product on next day
...
# Time-varying association between engagement in self-regulatory strategies and next day use of any nicotine-containing product
