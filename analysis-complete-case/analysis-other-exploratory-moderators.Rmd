...
summary(fit1, show_control_fit = TRUE, lincomb = c(1,1))
...
# Format output to 3 decimal places
dat_result %>% round(., 3) %>% format(., nsmall = 3) %>% write.csv(., file.path("analysis-complete-case", "formatted-output", "other-exploratory-moderators", "log_risk_ratio_scale_dichotomized_2qs_response.csv"), row.names = TRUE)
```
