...
g <- ggplot(data = dat_plot, aes(x = val, y = est, ymin = rrLB95, ymax = rrUB95))
g <- g + geom_abline(slope = 0, intercept = 1, color = "red", linewidth = 1) + geom_ribbon(alpha = 0.3) + geom_line(linewidth = 2) + scale_y_continuous(limits = c(0.75,2), breaks = seq(0.75, 2, 0.25), name = "Risk Ratio and 95% CI's") + scale_x_continuous(name = "Number of standard deviations above or below mean of gratitude", breaks = seq(-2,2,0.5), labels = seq(-2,2,0.5))
...
g <- ggplot(data = dat_plot, aes(x = val, y = est, ymin = rrLB90, ymax = rrUB90))
g <- g + geom_abline(slope = 0, intercept = 1, color = "red", linewidth = 1) + geom_ribbon(alpha = 0.3) + geom_line(linewidth = 2) + scale_y_continuous(limits = c(0.75,2), breaks = seq(0.75, 2, 0.25), name = "Risk Ratio and 90% CI's") + scale_x_continuous(name = "Number of standard deviations above or below mean of gratitude", breaks = seq(-2,2,0.5), labels = seq(-2,2,0.5))
