...
ggsave(filename = file.path("analysis-complete-case", "formatted-output", "H3-baseline-moderators", "log_risk_ratio_scale_H3_gratitude_CI90.png"), width = 7, height = 5, units = "in")
```
