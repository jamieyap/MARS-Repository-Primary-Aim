...
```{r}
est <- (fit_with_contrast$causal_excursion_effect[3:9,"Estimate"])
LB90 <- (fit_with_contrast$causal_excursion_effect[3:9,"90% LCL"])
UB90 <- (fit_with_contrast$causal_excursion_effect[3:9,"90% UCL"])

dat_plot <- data.frame(val = c(1,2,3,4,5,6,7), est = est, LB90 = LB90, UB90 = UB90)
...
```{r}
est <- exp(fit_with_contrast$causal_excursion_effect[3:9,"Estimate"])
LB90 <- exp(fit_with_contrast$causal_excursion_effect[3:9,"90% LCL"])
UB90 <- exp(fit_with_contrast$causal_excursion_effect[3:9,"90% UCL"])
