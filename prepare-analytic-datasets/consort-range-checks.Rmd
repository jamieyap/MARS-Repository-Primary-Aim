...
ggsave(filename = file.path("prepare-analytic-datasets", "plots", "Q1.png"), height = 10, width = 3, units = "in")
```
...
ggsave(filename = file.path("prepare-analytic-datasets", "plots", "Q2.png"), height = 10, width = 3, units = "in")
```
...
g <- ggplot(data = dat_for_calculation, aes(x = plot_no_group, y = elapsed_mins))
g + geom_violin(scale = "area", color = "cyan4", linewidth = 1) + geom_boxplot(color = "black", fill = "goldenrod", linewidth = 0.7, width = 0.10) + scale_y_continuous("Minutes Elapsed", limits = c(0, 140), breaks = seq(0,140,20), labels = seq(0,140,20)) + scale_x_continuous("", labels = NULL, breaks = NULL)
ggsave(filename = file.path("prepare-analytic-datasets", "plots", "Q3.png"), height = 10, width = 3, units = "in")
```
...
g <- ggplot(data = dat_for_calculation, aes(x = plot_no_group, y = elapsed_mins))
g + geom_violin(scale = "area", color = "cyan4", linewidth = 1) + geom_boxplot(color = "black", fill = "goldenrod", linewidth = 0.7, width = 0.10) + scale_y_continuous("Minutes Elapsed", limits = c(0, 140), breaks = seq(0,140,20), labels = seq(0,140,20)) + scale_x_continuous("", labels = NULL, breaks = NULL)
ggsave(filename = file.path("prepare-analytic-datasets", "plots", "Q4.png"), height = 10, width = 3, units = "in")
```
...
ggsave(filename = file.path("prepare-analytic-datasets", "plots", "R1.png"), height = 10, width = 3, units = "in")
```
...
ggsave(filename = file.path("prepare-analytic-datasets", "plots", "R2.png"), height = 10, width = 3, units = "in")
```

```{r}
dat_quants <- bind_cols(list_quants)
row.names(dat_quants) <- c("Minimum", "25th-Percentile", "50th-Percentile", "75th-Percentile", "Maximum")
write.csv(dat_quants, file.path("prepare-analytic-datasets", "plots", "checks_quantiles_minutes_elapsed.csv"), row.names = TRUE)
```
...
ggsave(filename = file.path("prepare-analytic-datasets", "plots", "rand.png"), height = 10, width = 3, units = "in")
```
...
ggsave(filename = file.path("prepare-analytic-datasets", "plots", "rand_no_prompt_by_block.png"), height = 10, width = 3, units = "in")
```
...
ggsave(filename = file.path("prepare-analytic-datasets", "plots", "rand_low_effort_prompt_by_block.png"), height = 10, width = 3, units = "in")
```
...
ggsave(filename = file.path("prepare-analytic-datasets", "plots", "rand_high_effort_prompt_by_block.png"), height = 10, width = 3, units = "in")
```
